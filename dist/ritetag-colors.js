        ...
        if (req.readyState === 4) {
          if (req.status === 200 || req.status === 304) {
            ...
            for (var i = res.length - 1; i >= 0; i--) {
              ...
              data = data.replace(new RegExp("#"+hashtag,'gi'), "<a title='Recommended By RiteTag' target='_blank' class='"+colors[color]+"' href='https://ritetag.com/hashtag-stats/"+hashtag+"'>#"+hashtag+"</a>");
            }
